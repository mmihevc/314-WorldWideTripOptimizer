...
export const CLIENT_TEAM_NAME = "T11 [hip, hip]";
...
export const TEAM_STATEMENT = 'Team [hip, hip] aims to work together combining our unique talents to provide exceptional ' +
...
export const JACKIE_BIO ='Jackie is a senior at Colorado State University majoring in Applied Computing Technology.' +
...
export const MADDIE_BIO = 'Maddie is an Applied Computing Technology major in her third year at Colorado State University. ' +
...
export const KAIS_BIO =  'Kai was born in Virginia Mason hospital on April 5th, 1999 to Michelle and Torsten. He had ' +
